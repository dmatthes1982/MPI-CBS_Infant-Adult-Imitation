...
%   cfg.path      = source path' (i.e. '/data/pt_01905/eegData/DualEEG_INFADI_processedDataOld/08b_pwelch/')
...
path      = ft_getopt(cfg, 'path', ...
              '/data/pt_01905/eegData/DualEEG_INFADI_processedDataOld/08b_pwelch/');
