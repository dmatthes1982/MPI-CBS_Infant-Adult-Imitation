function [passband] = INFADI_pbSelectbox()
% INFADI_PBSELECTBOX is a function, which displays a small GUI for the
% specification of passbands. It returns a cell array including the minimum
% and maximum frequency of each passband.
%
% Use as
%   [ passband ]  = INFADI_pbSelectbox( cfg )
%
