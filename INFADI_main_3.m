...
if ~exist('sessionStr', 'var')
  ...
  cfg.filename  = 'INFADI_d01_02b_preproc1';
...
if ~exist('numOfPart', 'var')                                               % estimate number of participants in preprocessed data folder
  ...
  for i=1:1:numOfSources
    numOfPart(i)  = sscanf(sourceList{i}, ...
                    strcat('INFADI_d%d_02b_preproc1_', sessionStr, '.mat'));
  end
end
...
for i = numOfPart
  ...
  data_continuous = INFADI_concatData( cfg, data_preproc1 );
  ...
  cfg_autoart1    = INFADI_autoArtifact(cfg, data_continuous);
  ...
  cfg_autoart2    = INFADI_autoArtifact(cfg, data_continuous);

  fprintf('\n<strong>Merge estimated artifacts...\n</strong>');
  cfg_autoart     = INFADI_mergeThArtResults(cfg_autoart1, cfg_autoart2);
