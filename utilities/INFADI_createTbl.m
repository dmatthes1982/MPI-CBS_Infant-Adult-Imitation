...
switch type
  case 'settings'
    ...
    T.Properties.VariableNames = ...
        {'dyad', 'noiChan', 'badChanPart1', 'badChanPart2', 'reference',...
         'ICAcorrValExp', 'ICAcompExp', 'ICAcompChild', 'artMethod', ...
         'artTholdExp', 'artTholdChild', 'artChanExp', 'artChanChild', ...
         'artRejectPLV', 'powSeglength', 'powOverlap', 'artRejectPow'};
