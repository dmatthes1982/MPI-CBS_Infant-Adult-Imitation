...
%   cfg.desFolder   = destination folder (default: '/data/pt_01905/eegData/DualEEG_INFADI_processedDataOld/00_settings/')
...
desFolder   = ft_getopt(cfg, 'desFolder', ...
          '/data/pt_01905/eegData/DualEEG_INFADI_processedDataOld/00_settings/');
...
switch type
  case 'settings'
    T = table(1,{'unknown'},{'unknown'},0,{'unknown'},0,{'unknown'},...
                {'unknown'},0,0,{'unknown'},{'unknown'},{'unknown'});
    T.Properties.VariableNames = ...
        {'dyad', 'badChanPart1', 'badChanPart2', 'fsample', 'reference',...
         'ICAcorrValExp', 'EOGcompExp', 'artMethod', 'artTholdExp', ...
         'artTholdChild', 'artChan', 'artRejectPLV', 'artRejectPSD'};
