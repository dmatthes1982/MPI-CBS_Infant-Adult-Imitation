...
%   cfg.desFolder   = destination folder (default: '/data/pt_01905/eegData/DualEEG_INFADI_processedDataOld/01_raw/')
...
% Get config options
% -------------------------------------------------------------------------
desFolder   = ft_getopt(cfg, 'desFolder', '/data/pt_01905/eegData/DualEEG_INFADI_processedDataOld/01_raw/');
