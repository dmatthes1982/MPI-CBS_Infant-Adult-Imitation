...
sessionList     = dir([tmpPath, 'INFADI_d*_01_raw_*.mat']);
...
switch part
  case 1
    fileNamePre = [];
    tmpPath = strcat(desPath, '01_raw/');
    fileNamePost = strcat(tmpPath, 'INFADI_d*_01_raw_', sessionStr, '.mat');
  case 2
    tmpPath = strcat(desPath, '01_raw/');
    fileNamePre = strcat(tmpPath, 'INFADI_d*_01_raw_', sessionStr, '.mat');
    tmpPath = strcat(desPath, '02b_preproc1/');
    fileNamePost = strcat(tmpPath, 'INFADI_d*_02b_preproc1_', sessionStr, '.mat');
  case 3
    tmpPath = strcat(desPath, '02b_preproc1/');
    fileNamePre = strcat(tmpPath, 'INFADI_d*_02b_preproc1_', sessionStr, '.mat');
  ...
  case 4
    ...
    fileNamePost = strcat(tmpPath, 'INFADI_d*_04c_preproc2_', sessionStr, '.mat');
  case 5
    tmpPath = strcat(desPath, '04c_preproc2/');
    fileNamePre = strcat(tmpPath, 'INFADI_d*_04c_preproc2_', sessionStr, '.mat');
